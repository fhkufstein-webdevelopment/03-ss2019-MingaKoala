function PasswordChecker(wrapperId, passwordInputFieldId, passwordSubmitButtonId) {
    ...
    this.checkForLength = function() {
        ...
        if(this.passwordField.value.length >= this.minLength)  //fehler weg das alles grün ist erkennt jetzt ab wann die länge passt//
    ...
    this.checkForSpecialCharacters = function() {
        ...
        return back; //this needs to be replaced!
    };
}
