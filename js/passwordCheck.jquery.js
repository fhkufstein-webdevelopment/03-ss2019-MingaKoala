function PasswordChecker(wrapperId, passwordInputFieldId, passwordSubmitButtonId) {
    ...
    this.wrapperField = $(wrapperId); //Hier wird die Kurzsschreibweise von jQuery verwendet
    this.passwordField = $(passwordInputFieldId); //Hier wird die Kurzsschreibweise von jQuery verwendet
    this.passwordSubmitButton = $(passwordSubmitButtonId); //Hier wird die Kurzsschreibweise von jQuery verwendet
